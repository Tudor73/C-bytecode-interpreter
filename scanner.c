...
Token scanToken() {
    ...
    switch (c) {
        ...
        case '!':
            return newToken(match('=') ? TOKEN_BANG_EQUAL : TOKEN_BANG);
        case '=':
            return newToken(match('=') ? TOKEN_EQUAL_EQUAL : TOKEN_EQUAL);
        case '<':
            return newToken(match('=') ? TOKEN_LESS_EQUAL : TOKEN_LESS);
        case '>':
            return newToken(match('=') ? TOKEN_GREATER_EQUAL : TOKEN_GREATER);
        case '"':
            return string();
    }
